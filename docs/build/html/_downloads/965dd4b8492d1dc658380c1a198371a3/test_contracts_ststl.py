...
c1.set_assume('G[0,3](5<=x)')                 # Set an assumption
c1.set_guaran('G[1,3](P{y-2w1+3w2<=8}=>0.85)')   # Set a guarantee
...
c2.set_assume('F[1,2](4<=x)')                 # Set an assumption
c2.set_guaran('G[1,3](P{y-2w1+3w2<=8}=>0.95)')   # Set a guarantee such that c2 refines c1
...
c3.set_assume('F[1,2](4<=x)')                 # Set an assumption
c3.set_guaran('G[1,3](P{y-2w1+3w2<=8}=>0.75)')   # Set a guarantee such that c3 does not refines c1
