...
Similarly, it is also possible to check refinement between probabilistic contracts. For an example with STL contracts refer to :download:`test_contracts.py <../../tests/test_contracts.py>` and :download:`test_contracts_stl.py <../../tests/test_contracts_stl.py>`. For an example with StSTL contracts refer to :download:`test_contracts_ststl.py <../../tests/test_contracts_ststl.py>`.

.. PySTL Contract Class
.. ^^^^^^^^^^^^^^^^^^^^
.. .. automodule:: pystl.contract
.. 	:members:
...
PySTL Contract Class and Its Operations
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
