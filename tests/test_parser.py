...
p = Parser(c1)
#  print(p("(G[0,10] ((0.0 x**2 + -0.0 x  + 0.0 y**2 + 1.0 y + -10.0 <= 0) & (0.0 x **2 + 0.0 x  + 0.0 y**2 + -1.0 y + 6.0 <= 0) & (0.0 x **2 + -1.0 x  + 0.0 y**2 + -0.0 y + 0.0 <= 0) & (0.0 x **2 + 1.0 x  + 0.0 y**2 + 0.0 y + -10000.0 <= 0)))"))
#  #  print(p("3", "int"))
#  print(p("y", "variable"))
...
print(p("3x**2 - 2y**3 + 2z", "expression_inner"))
print(p("3x**2 - 2y**3 + 2z", "expression_outer"))
#  print(p("(2y + 4 - 2 > 3)", "AP"))
