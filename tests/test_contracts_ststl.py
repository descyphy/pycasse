...
c1.add_deter_vars(['x', 'y'])                            # Set a deterministic uncontrolled variable
c1.add_nondeter_vars(['w1', 'w2'], \
        mean = [0, 2], cov = [[1**2, 0], [0, 1**2]])     # Set nondeterministic uncontrolled variables
...
c2.add_deter_vars(['x', 'y'])                            # Set a deterministic uncontrolled variable
...
c3.add_deter_vars(['x', 'y'])                            # Set a deterministic uncontrolled variable
