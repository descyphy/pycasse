...
class MILPSolver:
    ...
    Attributes
        ...
        b_var_num
    """
    __slots__ = ('verbose', 'mode', 'solver', 'objective', 'debug', 'contract', 'hard_constraints', 'soft_constraints', 'soft_constraints_var', 'dynamics', 'switching_dynamics', 'switching_condition',
    ...
    def add_soft_constraint(self, constraint):
        ...
        return len(self.soft_constraints) - 1
    ...
    def variable(self, idx, time, var_type = 'contract'):
